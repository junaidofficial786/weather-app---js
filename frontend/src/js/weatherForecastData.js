...
export const weatherForecastData = async (data, key = "616b8c33560dedc066c91582334a30c2") => {
  ...
  if (data.lat && data.lon) {
    // API_URL = `https://api.openweathermap.org/data/3.0/onecall?lat=${data.lat}&lon=${data.lon}&appid=${key}&units=metric`;
